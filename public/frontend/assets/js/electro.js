...
(function($) {
    ...
    $(document).ready(function() {
        ...
        function fadeIn() {
            ...
            $(owlElementID + " .active .caption .fadeIn-3")
                ...
                .delay(1000)
                .animate({opacity: 1}, {duration: 800, easing: "easeOutCubic"});
            $(owlElementID + " .active .caption .fadeIn-4")
                .stop()
                .delay(1000)
                .animate({opacity: 1}, {duration: 800, easing: "easeOutCubic"});
        }
        ...
        function fadeInDown() {
            ...
            $(owlElementID + " .active .caption .fadeInDown-4")
                .stop()
                .delay(1000)
                .animate(
                    {opacity: 1, top: "0"},
        ...
        function fadeInUp() {
            ...
            $(owlElementID + " .active .caption .fadeInUp-4")
                .stop()
                .delay(1000)
                .animate(
                    {opacity: 1, top: "0"},
        ...
        function fadeInLeft() {
            ...
            $(owlElementID + " .active .caption .fadeInLeft-4")
                .stop()
                .delay(1000)
                .animate(
                    {opacity: 1, left: "0"},
        ...
        function fadeInRight() {
            ...
            $(owlElementID + " .active .caption .fadeInRight-4")
                .stop()
                .delay(1000)
                .animate(
                    {opacity: 1, left: "0"},
        ...
        var $owl_recently_added_products_carousel = $(
            "#recently-added-products-carousel .owl-carousel"
        );
        $owl_recently_added_products_carousel.on(
        ...
        var $owl_home_v3_carousel_tabs = $(
            ".home-v3-owl-carousel-tabs .owl-carousel"
        );
        $owl_home_v3_carousel_tabs.on(
            "initialized.owl.carousel translated.owl.carousel",
            function() {
                var $this = $(this);
                $this.find(".owl-item.last-active").each(function() {
        ...
        var $owl_home_v2_carousel_tabs = $(
            ".home-v2-owl-carousel-tabs .owl-carousel"
        );
        $owl_home_v2_carousel_tabs.on(
            "initialized.owl.carousel translated.owl.carousel",
            function() {
                var $this = $(this);
                $this.find(".owl-item.last-active").each(function() {
        ...
        var $owl_product_carousel_with_image = $(
            "#products-carousel-with-umage .owl-carousel"
        );
        $owl_product_carousel_with_image.on(
            "initialized.owl.carousel translated.owl.carousel",
            function() {
                var $this = $(this);
                $this.find(".owl-item.last-active").each(function() {
        ...
        var $owl_homev3_products_cards_carousel = $(
            "#homev3-products-cards-carousel .owl-carousel"
        );
        $owl_homev3_products_cards_carousel.on(
            "initialized.owl.carousel translated.owl.carousel",
            function() {
                var $this = $(this);
                $this.find(".owl-item.last-active").each(function() {
        ...
        var $owl_product_category_carousel = $(
            "#product-category-carousel .owl-carousel"
        );
        $owl_product_category_carousel.on(
            "initialized.owl.carousel translated.owl.carousel",
            function() {
                var $this = $(this);
                $this.find(".owl-item.last-active").each(function() {
    ...
    jQuery(document).ready(function($) {
        ...
        function accessory_checked_variable_product_ids() {
            ...
            $(".accessory-checkbox .product-check").each(function() {
                if (
                    $(this).is(":checked") &&
                    $(this).data("product-type") == "variable"
                ) {
        ...
        $(".accessory-checkbox .product-check").on("click", function() {
            $.ajax({
                cache: false,
                url:
                    "http://demo2.transvelo.in/electro/wp-admin/admin-ajax.php",
                success: function(result) {
                    var previous_price = $("span.total-price-html .amount")
                        .text()
                        .replace(/\.|\,/g, "");
                    var current_price = accessory_checked_total_price()
                        .toFixed(2)
        ...
        $(".accessories-add-all-to-cart .add-all-to-cart").on(
            "click",
            function() {
                ...
                if (accerories_all_product_ids.length === 0) {
                    var accerories_alert_msg =
                        '<div class="woocommerce-error">No Products selected.</div>';
                } else if (
                    accerories_variable_product_ids.length > 0 &&
                    accessory_is_variation_selected() === false
                ) {
                    var accerories_alert_msg =
                        '<div class="woocommerce-error">Product Variation does not selected.</div>';
                } else {
                    for (
                        var i = 0;
                        i < accerories_all_product_ids.length;
                        i++
                    ) {
                        if (
                            !$.inArray(
                                accerories_all_product_ids[i],
                                accerories_variable_product_ids
                            )
                        ) {
                            var variation_id = $(
                    ...
                    var accerories_alert_msg =
                        '<div class="woocommerce-message">Products was successfully added to your cart. <a class="button wc-forward" href="http://demo2.transvelo.in/electro/cart/">View Cart</a></div>';
                }
    ...
    $(document).ready(function() {
        $(".add_to_wishlist").on("click", function() {
            $(this)
                .closest(".images-and-summary")
                .block();
            $(this)
                .closest(".product-inner")
                .block();
            $(this)
                .closest(".product-list-view-inner")
                .block();
            $(this)
    ...
    $(document).ready(function() {
        ...
        switch (hash_value) {
            ...
            case "#grid":
                $('.shop-view-switcher a[href="' + hash_value + '"]').tab(
                    "show"
                );
                break;
        ...
        var departments_menu_height = $(
                ".page-template-template-homepage-v2 .departments-menu > li > ul.dropdown-menu"
            ).height(),
            home_fullwidth_slider_height = $(
                ".page-template-template-homepage-v2 .home-v2-slider"
            ).height(),
        ...
        $(".page-template-template-homepage-v2 #sidebar").css(
            "margin-top",
            sidebar_margin_top
        );
        ...
        $(".price-add-to-cart > .price").each(function() {
            ...
            if ($this[0].scrollWidth > $this.innerWidth()) {
                ...
                if (is_rtl) {
                    $this
                        .find("del")
                        .attr("style", "position:absolute;right:0;top:-14px;");
                } else {
                    $this
                        .find("del")
                        .attr("style", "position:absolute;left:0;top:-14px;");
                }
            }
        });
        ...
        $list_group_dd.attr(
            "style",
            list_group_dd_style ? list_group_dd_style : ""
        );
        ...
        $departments_menu_dropdown
            ...
            .each(function() {
                ...
                $(this).css(
                    "min-height",
                    departments_menu_dropdown_height + 28
                );
            });

        $(".vertical-menu, .departments-menu-dropdown").on(
            "mouseleave",
            function() {
                var $this = $(this);
        ...
        $(
            ".vertical-menu .menu-item-has-children, .departments-menu-dropdown .menu-item-has-children"
        ).on({
            mouseenter: function() {
                var $this = $(this),
                    $dropdown_menu = $this.find(".dropdown-menu"),
                    $vertical_menu = $this.parents(".vertical-menu"),
                    $departments_menu = $this.parents(
        ...
        $(".single-product .electro-gallery").each(function() {
            ...
            var cols = parseInt(
                thumbnail_column_class.replace("thumbnails-all columns-", "")
            );
        ...
        $(".electro-store-directory .product-categories > li").arrangeObjects(
            "ul",
            4
        );
